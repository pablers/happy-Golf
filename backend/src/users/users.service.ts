...
export class UsersService {
  ...
  /** Busca un usuario por correo electrnico para los flujos de autenticacin. */
  async findOneByEmail(email: string): Promise<User | undefined> {
    return this.usersRepository.findByEmail(email);
  }

  /** Recupera un usuario por id cuando otros mdulos necesitan informacin detallada. */
   ...
   * Devuelve una vista pǧblica sin exponer el hash de la contrasea.
   */
  ...
  /**
   * Obtiene un usuario en formato seguro o lanza una excepcin si no existe.
   */
