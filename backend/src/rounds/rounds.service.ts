...
export class RoundsService {
  ...
  async list(userId: number): Promise<Round[]> {
  ...
  async getById(userId: number, roundId: string): Promise<Round> {
  ...
  async create(userId: number, payload: CreateRoundDto): Promise<Round> {
  ...
  async update(userId: number, roundId: string, payload: UpdateRoundDto): Promise<Round> {
  ...
  async remove(userId: number, roundId: string): Promise<void> {
    await this.ensureOwnership(userId, roundId);
  ...
  private async ensureOwnership(userId: number, roundId: string): Promise<void> {
